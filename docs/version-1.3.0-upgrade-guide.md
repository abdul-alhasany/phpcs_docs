# PHP_CodeSniffer 1.3.0 Upgrade Guide
...
A simple `ruleset.xml` file like this tells PHP*CodeSniffer that this directory contains a coding standard, the name of the standard is \_My Standard* and the sniffs in the standard are sourced directly from the default `Sniffs` directory.
